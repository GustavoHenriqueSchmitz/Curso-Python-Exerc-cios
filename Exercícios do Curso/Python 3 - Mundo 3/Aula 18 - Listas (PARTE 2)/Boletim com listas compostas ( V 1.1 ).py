...
while True:
    ...
    # adicionando na lista (nomenota)
    nomenota.append((str(input('Nome do aluno:'))))
    nomenota.append((float(input('Nota 1: '))))
    nomenota.append((float(input('Nota 2: '))))
    ...
    media = (nomenota[1] + nomenota[2]) / 2 #Aqui ele forma a média pegando as notas da lista (nomenota)
    nomemedia.extend((nomenota[0], media))
